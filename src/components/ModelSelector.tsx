...
export default function ModelSelector({ label, models, selected, onChange, color }: Props) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-xs font-mono tracking-widest uppercase text-[#334155] dark:text-[#f5f6f7]">
        {label}
      </label>
      <div className="relative">
        <select
          ...
          className="w-full appearance-none bg-[#f8fafc] dark:bg-[#111827] border rounded px-3 py-2.5 text-base font-mono text-[#0f172a] dark:text-[#e2e8f0] cursor-pointer focus:outline-none focus:ring-1 pr-8 transition-colors"
      ...
      {selectedModel && (
        <div className="flex items-center gap-2 text-xs font-mono text-[#334155] dark:text-[#f5f6f7] bg-[#f1f5f9] dark:bg-[#0d1220] rounded p-2">
