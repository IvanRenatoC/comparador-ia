      ...
      <div className="relative bg-[#0d1220] border border-[#2d4060] rounded-xl w-full max-w-2xl max-h-[90vh] overflow-auto shadow-2xl">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e2d45] sticky top-0 bg-[#0d1220] z-10">
          <div>
            ...
            <p className="text-[10px] text-[#4b5e7a] font-mono mt-0.5">Pega el contenido, valida y compara temporalmente</p>
          </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="ej: Mi Modelo Custom 7B"
            ...
            />
            {displayName && (
              <p className="text-[10px] font-mono text-[#4b5e7a] mt-1">
                Slug: custom-{slugify(displayName)}
              </p>
            )}
          </div>
          ...
          {preview && (
            <div className="bg-[#080b14] border border-[#10b981]/30 rounded-lg p-4 space-y-3">
              <div className="flex items-center gap-2 text-[10px] font-mono text-[#10b981]">
                <span>✓</span>
                <span>JSON válido — métricas extraídas</span>
              </div>
              ...
              {preview.missingFields.length > 0 && (
                <p className="text-[10px] font-mono text-[#f59e0b]">
                  Campos faltantes: {preview.missingFields.join(', ')}
                </p>
              )}
              ...
              <div className="bg-[#111827] rounded p-3 text-[10px] font-mono text-[#4b5e7a] leading-relaxed">
                <div className="text-[#f59e0b] mb-1">Para agregar permanentemente:</div>
                <div className="text-[#94a3b8]">1. Descarga el JSON y cópialo en models-config-contrast/</div>
                <div className="text-[#94a3b8]">2. Ejecuta: npm run build:model-index</div>
                <div className="text-[#94a3b8]">3. Ejecuta: npm run generate:explanations</div>
              </div>
            </div>
          )}
        </div>
